...
using demo.demo.Tests.DependencyInjection;
using Shesha;
...
namespace demo.demo.Common.Tests
{
    [DependsOn(
        typeof(demoModule),
    ...
    public class demoCommonDomainTestModule : AbpModule
    {
        private string ConnectionString;

        public demoCommonDomainTestModule(SheshaNHibernateModule nhModule)
        {
